...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 29 + 84) / 169)
exe '2resize ' . ((&lines * 27 + 21) / 43)
exe 'vert 2resize ' . ((&columns * 139 + 84) / 169)
exe '3resize ' . ((&lines * 13 + 21) / 43)
exe 'vert 3resize ' . ((&columns * 139 + 84) / 169)
argglobal
enew
file NERD_tree_1
let s:cpo_save=&cpo
...
wincmd w
argglobal
terminal ++curwin ++cols=139 ++rows=13 
